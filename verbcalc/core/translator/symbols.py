...
class Symbols:
    ...
    def __init__(self):
        ...
        self._roots = ['root of']
        self._questions = ['what is the result of', 'what is', 'calculate', 'when','if', 'result of','addition of','how do you','find','how much','how much is', 'which number is result of', 'subtraction of','what' ]
